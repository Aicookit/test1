...
#设置背景图片
image = Image.open('D:\Pictures\img1.jpg')
...
def get_words_lsit():
    words_list = []
    with open('D:\homework\Doc\doc1.txt', 'r+')as f:
...
# 读取游戏规则
def get_game_rule():
    with open('D:\homework\Doc\README.md', 'r+')as f:
        content = f.read()
...
def start_game():
    ...
    try:
        ...
        if len(words_list) != 0:
            ...
            tkMessageBox.showinfo(title='谁是卧底', message='天啊，我竟然猜不到！')
    except Exception:
